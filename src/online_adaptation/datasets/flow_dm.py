# Taken from https://raw.githubusercontent.com/liy1shu/open_anything_diffusion/main/src/open_anything_diffusion/datasets/flowbot.py
# Because there are some deficiencies in Flowbot3d.
...
class FlowBotDataModule(L.LightningDataModule):
    def __init__(
        ...
        **kwargs,
        ...
        elif ds_type == "flowbot_history_tformer":
            dset_cls = FlowDatasetTformerHistory
        ...
        self.train_dset = CachedByKeyDataset(
            ...
            root=root,
            processed_dirname=dset_cls.get_processed_dir(
                True,
                randomize_camera,
            ),
            n_repeat=100,
